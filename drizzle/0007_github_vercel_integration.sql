...
CREATE TABLE IF NOT EXISTS `project_vercel_deployments` (
	`id` int AUTO_INCREMENT NOT NULL,
	`projectId` int NOT NULL,
	`userId` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vercel_deployment_history` (
	`id` int AUTO_INCREMENT NOT NULL,
	`projectId` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `github_vercel_sync_logs` (
	`id` int AUTO_INCREMENT NOT NULL,
	`projectId` int NOT NULL,
